...
int  player_can_seek(void);        // current source has a finite, seekable timeline
...
void player_set_startup_headstart(int on); // next play buffers audio/video before starting
